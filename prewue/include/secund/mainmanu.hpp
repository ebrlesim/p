...
namespace mo
{
    ...
    void LoadDataMain (mo:: Data * data)
    {   
        int special = 0;
        std :: string h;
        h = data -> h[0];
    ...
    void workMeinMenu (mo:: Data* data, mo:: Texts *text, mo :: Shapes * shapes)
    {
        for (int i = 0; i < 6; i++)
        {   
            if (data -> cursor ==i)
    ...
    void ArawsMain (mo:: Data * data, mo:: Shapes * shapes)
    {
    ...
    void hedlainMain (mo:: Data *data, mo:: Texts * text , mo :: Shapes * shapes)
    {   
    std :: string h;
    h=data->h[0];
    float lenght = 0;
